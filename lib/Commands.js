...
function commands() {
  return [
    ...
    { key: "theme.font",  title: "Change Font",              subtitle: "Pick the system monospace",   icon: "󰛖", kind: "shell", argv: ["omarchy", "menu", "summon", "style.font"], keywords: "font typeface monospace typography" },
