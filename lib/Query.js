...
// a view this chooses between it and what follows: an app named exactly what
// was typed, then a view named exactly that, then, for a single matching
...
function firstSelectableIndex(rows, value) {
  ...
  if (completions.length === 1)
    return completions[0] === typed || prefixApp < 0 ? first : prefixApp
