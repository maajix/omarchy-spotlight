...
// The key engineOptions() lists for this engine: "google" -> "g". An unknown
// key is the default engine.
function canonicalEngine(key) {
  var name = lookupEngine(key).name
  return engineOptions().filter(function(o) { return o.label === name })[0].value
}
